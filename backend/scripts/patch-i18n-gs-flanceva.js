 ...
 * коди моделей і одиниці (ГС-31Ф → «HS-31F/GS-31F/ГС-31Ф» врозбій, ДУ → «DU/GW/FF»).
 ...
 *
 * Порядок:
 *   1) node backend/scripts/apply-gs-flanceva.js
...
const DATA = path.join(__dirname, 'gs-flanceva-i18n.json')
