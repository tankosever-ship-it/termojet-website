...
const RETURN_CONDITIONS = [
  ...
  'Технічно складні товари повертаються за умови відсутності слідів монтажу та підключення.',
...
const NO_RETURN_CONDITIONS = [
  ...
  'Комплектуючі та витратні матеріали (фільтри, ущільнювачі) після відкриття упаковки.',
  'Програмне забезпечення та електронні ліцензії після активації.',
]

const EXCHANGE_CONDITIONS = [
  'Якщо придбаний товар не підійшов за технічними характеристиками, ви можете обміняти його протягом 14 календарних днів.',
  'Обмін на інший товар з нашого асортименту з перерахунком вартості.',
  'При виявленні виробничого дефекту — обмін або безкоштовний ремонт протягом гарантійного терміну.',
...
const STEPS = [
  ...
  },
  {
    num: '03',
    icon: RefreshCw,
    title: 'Відправте товар та отримайте кошти',
    desc: 'Упакуйте товар в оригінальну упаковку та відправте на наш склад. Після перевірки повертаємо кошти протягом 7 робочих днів на ваш банківський рахунок.',
  },
]
