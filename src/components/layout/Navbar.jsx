...
export default function Navbar() {
  ...
  // повторний скан ЛИШЕ при відкритті меню — це в контексті тапу користувача.
  // (Не гукаємо на зміні маршруту без жесту: iOS Safari сприймає обробку tel:
  //  поза user-gesture як спробу авто-дзвінка і блокує з попапом.)
