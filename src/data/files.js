...
export const FILES = [
  ...
  { id: 197, name: 'Інструкція — Пелетний котел Termojet Ignis Pro 15 Plus', category: 'Інструкції', format: 'PDF', url: '/files/ignis-pro-15-plus-manual-ua.pdf', lang: 'uk', year: 2026, desc: 'Пелетний котел 15 кВт із пальником OXI MINI: монтаж і обв\'язка, вимоги до димаря, перший запуск, меню контролера OXI 1.0S/2.0S і Wi-Fi, режими горіння, обслуговування й чищення, аварії та їх усунення, гарантійний талон · 64 сторінки' },
  { id: 198, name: 'Брошура — Пелетний котел Termojet Ignis Pro 15 Plus', category: 'Брошури', format: 'PDF', url: '/files/ignis-pro-15-plus-broshura-ua.pdf', lang: 'uk', year: 2026, desc: 'Коротко про котел: модуляція 4,3–15,2 кВт, ККД до 92 %, клас 5 і A+ за випробуваннями ZETOM, автономність бункера в годинах, п\'ять ступенів захисту, повний комплект поставки · 2 сторінки A4' },
]
