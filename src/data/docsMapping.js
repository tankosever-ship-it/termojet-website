...
export const DOCS_BY_NAME = [
  ...
  { match: /зональн.{0,12}клапан|ABF-ZV|ABF01-3/i, ids: [144, 186, 176], exclusive: true }, // зональні клапани ABF-ZV3: UA, двомовна, EN
  ...
  { match: /\bTBE\b/i,                  ids: [143, 152, 188, 178] }, // каталог + інструкція TBE: UA, двомовна, EN
  { match: /\bTI[\s-]?400\b|титанов\S*\s+акт\S*\s+анод|215001(68|69)/i, ids: [151, 187, 177] },
  ...
  // Порядок id: українська, двомовна, англійська.
  { match: /\bTMV\d|Термостатичний триходовий клапан/i, ids: [160, 180, 170] },
  { match: /\bRMV0\d|Триходовий змішувальний кран|Чотирьохходовий змішувальний кран/i, ids: [161, 181, 171] },
  { match: /TJ-MU-10B/i,                ids: [162, 182, 172] },
  { match: /TJ-MU-25/i,                 ids: [163, 183, 173] },
  { match: /84040TJ-(R-)?W-\d/i,        ids: [164, 184, 174] },
  { match: /AQUA\s?O?4(0[15]|11|12)/i,  ids: [165, 185, 175] },
