...
export const T = {
  uk: {
    ...
    hero: {
      ...
      subtitle: 'Понад 50 000 об\'єктів оснащено обладнанням Termojet по всій Україні та в 15 країнах ЄС.',
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'Over 50,000 facilities equipped with Termojet products across Ukraine and in 15 EU countries.',
