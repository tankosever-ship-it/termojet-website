  ...
  uk: {
    ...
    deliveryPage: {
      ...
      payment: {
        ...
        methods: [
          { title: 'Безготівковий розрахунок', desc: 'Оплата на розрахунковий рахунок компанії з ПДВ. Для юридичних осіб та ФОП виставляємо рахунок-фактуру. Відвантаження після надходження коштів.' },
          { title: 'Передоплата', desc: 'При замовленні нестандартних конфігурацій або позицій під замовлення — передоплата 50%. Залишок сплачується перед відвантаженням.' },
          { title: 'Оплата карткою онлайн', desc: 'Оплата карткою Visa / Mastercard через захищений платіжний шлюз LiqPay. Доступна при оформленні замовлення на сайті termojet.com.ua.' },
        ],
      },
      info: { title: 'Важлива інформація', items: ['Замовлення, оформлені до 14:00, обробляються в той самий день.', 'Всі ціни вказані в гривнях з ПДВ 20%.', 'При отриманні товару обов\'язково перевірте цілісність пакування у присутності кур\'єра.', 'У разі пошкодження — складіть акт з перевізником та сфотографуйте ушкодження.', 'Доставка за кордон розраховується індивідуально — зверніться до менеджера.'] },
    },
    footer: {
