...
- встановлено **Google Tag Manager** (контейнер `GTM-P9DW9P6D`);
...
|---|---|---|
| **Google Tag Manager** (контейнер `GTM-P9DW9P6D`) | Налаштування тегів GA4 | потрібен доступ Edit/Publish |
...
Контейнер `GTM-P9DW9P6D` вставлено на всі сторінки сайту (у `<head>` та одразу після `<body>`). Окремо налаштовувати на сайті більше нічого не треба.
...
### 4.2. Налаштувати теги в GTM (контейнер `GTM-P9DW9P6D`)
...
- [ ] Надано доступ до GTM-контейнера `GTM-P9DW9P6D`
