...
- Прайс перезібрано повністю: `TERMOJET-прайс-2026-09.xlsx` (418 позицій), CSV і
  `termojet-feed.xml`. Усі 156 гривневих позицій прайсу збігаються з сайтом.
...
- **Підставка на 150 кг** уперше зʼявилась у прайсі окремим рядком, зі старою ціною
  6 870 грн і без артикула: у підняття вона не входила, бо ключем був артикул.
